      ...
      <div className={`container ${styles.inner}`}>
        <div className={styles.left}>
          ...
          <p className={styles.sub}>
            Talk to our expert advisors at Shashwat Insurance Services. We'll help you find the perfect plan from our 8 trusted partners — completely free of charge.
          </p>
        </div>
        <div className={styles.right}>
          ...
          >
            ...
            Follow @insurewithsamartth
          </a>
          <p className={styles.note}>No obligation · Expert advice · IRDAI certified partners</p>
        </div>
      </div>
